...
//    private Scanner scanner = new Scanner(System.in);
	...
	private void createFreqLists() {
		...
		// Make the list
		while (itrNatural.hasNext() && counter < 10) {
	...
	public void printResult() {
		...
		System.out.println("Frequency Tree:" + "Optimum Height: " + optHeight(wordsByFreqDesc.size()) + " " + "Actual Height: " + wordsByFreqDesc.size());
